...
int main() {
	...
	dev_handle = libusb_open_device_with_vid_pid(ctx, 0x0483, 0xff11); //these are vendorID and productID I found for my usb device
	if(dev_handle == NULL)
	...
	r = libusb_bulk_transfer(dev_handle, (0x1 | LIBUSB_ENDPOINT_OUT), data, 2, &actual, 0); //my device's out endpoint was 2, found with trial- the device had 2 endpoints: 2 and 129
